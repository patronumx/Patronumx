...
// --- Icons (smaller, brand-safe colors) ---
const MonitorIcon = () => (
...
const featuresData = [
  {
    ...
    title: 'AI Automation',
    description: 'Deploy intelligent agents to automate complex workflows and business processes.',
    buttonLink: '#',
  },
  {
    icon: <CloudIcon />,
    title: 'Predictive Insights',
    description: 'Leverage advanced machine learning algorithms to forecast trends and optimize performance.',
    buttonLink: '#',
  },
  {
    icon: <ShieldIcon />,
    title: 'Adaptive Security',
    description: 'Real-time threat detection and response powered by state-of-the-art neural networks.',
    buttonLink: '#',
  },
];
...
const Features = () => {
  return (
    <section id="features" className="relative py-10 sm:py-14 lg:py-16 overflow-hidden">
      {/* Background decoration (smaller, softer) */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[520px] h-[520px] bg-purple-500/5 rounded-full blur-2xl" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-5 lg:px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-400/20 backdrop-blur-sm mb-3">
            <span className="text-[12px] font-medium text-purple-300">Our Capabilities</span>
          </div>
          ...
          <p className="text-sm sm:text-[15px] text-slate-400 max-w-xl mx-auto">
            Comprehensive solutions to power your digital transformation
          </p>
        </motion.div>

        {/* Feature Grid (tighter gaps) */}
        <motion.div
        ...
        >
          {featuresData.map((feature, index) => (
            ...
            >
              ...
              <div className="absolute -inset-px rounded-xl bg-gradient-to-br from-purple-500/40 via-blue-500/40 to-purple-500/40 opacity-0 group-hover:opacity-100 blur-lg transition-opacity duration-500" />

              {/* Card (reduced padding/rounding) */}
              <div className="relative h-full bg-slate-900/60 backdrop-blur-md rounded-xl border border-white/10 p-4 sm:p-5 flex flex-col group-hover:border-purple-400/30 transition-all duration-300">
                {/* Icon (smaller container) */}
                <div className="flex items-center justify-center w-11 h-11 rounded-lg bg-gradient-to-br from-purple-500/20 to-blue-500/20 border border-purple-400/20 mb-4 group-hover:scale-105 group-hover:shadow-md group-hover:shadow-purple-500/40 transition-all duration-300">
                  {feature.icon}
                </div>
                ...
                <p className="text-slate-400 text-[13px] sm:text-sm leading-relaxed flex-grow group-hover:text-slate-300 transition-colors duration-300">
                  {feature.description}
                </p>

                {/* Hover arrow indicator (compact) */}
