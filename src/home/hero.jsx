...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pt-32 pb-14 sm:pt-48 sm:pb-16 flex flex-col items-center text-center">
        ...
        >
          <span className="block text-white">Revolutionizing SaaS</span>
        ...
        >
          Unleash the full potential of your business with our AI-driven SaaS platform.
          Automate workflows, enhance decision-making, and scale effortlessly with
