    ...
    <section className="relative overflow-hidden py-10 sm:py-14 bg-transparent text-white text-center">
      ...
      >
        <div className="flex flex-col items-center justify-center w-full">
          <p className="font-semibold text-yellow-400 mb-2 text-base">
            Let's Try!
          </p>
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-3 w-full">
            Grow Your Restaurant Sale
          </h2>
          <p className="text-sm md:text-base text-gray-300 max-w-2xl mx-auto mb-5 w-full">
            We are helping restaurants across Pakistan stay profitable. Let us help you increase business.
          </p>
          <button
            type="button"
            className="inline-block px-8 py-2.5 rounded-full font-semibold text-white cta-button-gradient"
