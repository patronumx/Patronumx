...
// import patronumLogo from "../assets/Plogo.png"; // removed per request
            ...
            <div className="rounded-[22px] border border-white/10 px-6 py-8 sm:px-8 sm:py-10 lg:px-10 lg:py-12">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10 items-center">
                ...
                <div className="lg:col-span-2">
                  ...
                  >
                    Welcome to PatronumX — AI-Native Tech Powerhouse
                  </motion.h2>
                  ...
                  >
                    PatronumX is an <span className="font-semibold text-purple-300">AI & SaaS innovation firm</span> backed by
                    <span className="font-semibold text-purple-300"> 4+ years</span> of engineering excellence.
                    We build autonomous solutions across <span className="font-semibold text-purple-300">Generative AI</span>,{" "}
                    <span className="font-semibold text-purple-300">Intelligent SaaS</span>,{" "}
                    <span className="font-semibold text-purple-300">Predictive Analytics</span>, and{" "}
                    <span className="font-semibold text-purple-300">Automated CRM</span>—designed for scale, precision,
                    and intelligence.
                  </motion.p>
                  ...
                  >
                    Our team has deployed <span className="font-semibold text-purple-300">50+ AI models</span> and modern
                    SaaS platforms for clients worldwide—specializing in agentic workflows, cloud infrastructure, realtime data
                    pipelines, and cognitive systems that power the next generation of digital business.
                  </motion.p>
